...
colors.push('orange', 'white', 'black');
const colorsWithBlue = colors.includes((color) => color.includes('blue'));
console.log(colorsWithBlue);
console.log('Colors array:', colors);
console.log('Colors with blue:', colorsWithBlue);
const filteredColors = colors.filter((color) => color.length > 4);
console.log('Filtered colors (length > 5):', filteredColors);
